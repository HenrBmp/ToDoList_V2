...
export async function loadTasks(tasksJSON) {
    ...
    tasksJSON.forEach(async task => {
        ...
        const done_buttton = await createSVG("M480-80q-83 0-156-31.5T197-197q-54-54-85.5-127T80-480q0-83 31.5-156T197-763q54-54 127-85.5T480-880q83 0 156 31.5T763-763q54 54 85.5 127T880-480q0 83-31.5 156T763-197q-54 54-127 85.5T480-80Zm0-80q134 0 227-93t93-227q0-134-93-227t-227-93q-134 0-227 93t-93 227q0 134 93 227t227 93Zm0-320Z");
        done_buttton.classList.add("done-check");
        done_buttton.addEventListener(
            "click",
            function doneCheckClick() {
                // TODO: alterar classe done e o svg path do done_button
            }
        );
        ...
        const edit_button = await createSVG("M200-200h57l391-391-57-57-391 391v57Zm-80 80v-170l528-527q12-11 26.5-17t30.5-6q16 0 31 6t26 18l55 56q12 11 17.5 26t5.5 30q0 16-5.5 30.5T817-647L290-120H120Zm640-584-56-56 56 56Zm-141 85-28-29 57 57-29-28Z");
        ...
        const delete_button = await createSVG("m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z");
